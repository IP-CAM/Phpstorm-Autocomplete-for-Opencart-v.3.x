...
abstract class ModelCheckoutRecurring extends Model {
	abstract public function addRecurring($order_id, $description, $data) {
	...
	abstract public function editReference($order_recurring_id, $reference) {
